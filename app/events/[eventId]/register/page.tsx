...
export default function EventRegisterPage({ params }: EventRegisterPageProps) {
  ...
  // For fixed pricing this is always event.registrationFee.
  // For dynamic pricing it reads the price from the selected option in pricingFieldId.
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // For dynamic pricing, validate that the pricing field has a value with a known price
